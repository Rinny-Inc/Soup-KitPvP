...
import io.noks.kitpvp.listeners.abilities.AntiGladiator;
import io.noks.kitpvp.listeners.abilities.AntiStomper;
...
public class AbilitiesManager {
	...
	public AbilitiesManager(Main main) {
		...
		abilities.add(new Specialist(main));
		abilities.add(new CookieMonster(main));
		abilities.add(new AntiGladiator());
		abilities.add(new AntiStomper());
		abilities.add(new Grandpa());
